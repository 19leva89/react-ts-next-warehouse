	...
	return (
		<section id='background' className='flex h-screen w-screen items-center justify-center bg-slate-600'>
			<div id='box' className='flex w-full flex-col px-8 md:h-3/4 md:w-1/2 md:flex-row'>
				<div id='image' className='md:h-full md:w-1/2'>
					<Image
						...
						className='h-64 w-full rounded-t-xl object-cover md:h-full md:w-full md:rounded-l-xl md:rounded-tr-none'
						width={400}
						height={500}
						alt='Cat'
					/>
				...
				<div
					id='login-form'
					className='relative flex h-full w-full flex-col items-center justify-center rounded-b-xl bg-white p-8 md:w-1/2 md:rounded-r-xl md:rounded-bl-none'
				>
